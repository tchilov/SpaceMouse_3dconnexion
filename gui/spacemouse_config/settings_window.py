...
class SettingsWindow(QMainWindow):
    ...
    def set_profile_name(self, name, wm_class=None, is_passthrough_profile=None):
        self.live_bar.set_profile(
            name, wm_class=wm_class, is_passthrough_profile=is_passthrough_profile
        )
